...
| [0053](0053-local-enforcement-floor.md) | The enforcement floor is local, permanently: `bin/quality` plus `.githooks/pre-push` are the gate, not a stopgap for CI; what fourteen steps guarantee, and the four residuals they cannot | 1→Continuous | **Accepted** |
