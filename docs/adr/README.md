...
| [0052](0052-a-migration-is-a-dated-act.md) | A migration is a dated act, not a live query: grant targets are frozen literals, never read from the seeder map; a convergence migration aborts only on a condition its own writes would create | 1 | **Accepted** |
