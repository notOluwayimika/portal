 ...
 * this commit: `bin/quality:251` is `pest --group=arch` (step 14) and `:279` is plain `pest`
 * (step 16); `--parallel` appears only on Pint (`composer.json:67,70`). Both line numbers and both
