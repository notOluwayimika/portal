...
export default function MarkingComponentsTab() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await axios.post('/api/marking-components', data);
    ...
    return (
        <div className="mx-auto max-w-2xl p-6">
            <div className="page-hdr">
                <div>
                    <h1>Marking Components</h1>
                    <p>
                        These default components apply to curriculum subjects
                        but can be modified per subject later. Weights must add
                        up to exactly 100% before you can save.
                    </p>
                </div>
            </div>
