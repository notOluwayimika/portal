...
**Status:** open. Found 2026-09-01 while checking whether step 6 could be built off `staging`.
...
Unassigned. It is a trust-boundary ruling about money, not a data-model question, so it is not
obviously Developer 1's; no owner is invented here.
