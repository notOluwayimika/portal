...
class GuardianImportRowValidator
{
    ...
    public function validate(array $row): array
    {
        ...
        foreach (array_keys(self::COLUMNS) as $col) {
            $val = $row[$col] ?? null;
            // A numeric spreadsheet cell (e.g. admission_number 20251237) parses
            // as int/float; stringify so downstream string comparisons — notably
            // the admission_number lookup against the varchar column — match.
