const sections = [
    { name: 'Secondary', count: 524, pct: 42, color: '#2c197a' },
...
export function PopulationOverview() {
    return (
        <div className="bg-white border border-slate-200 rounded-lg p-4 dark:bg-slate-900 dark:border-slate-700">
            <p className="text-sm font-medium text-slate-900 dark:text-slate-100 mb-4">Population overview</p>
            ...
            <div className="border-t border-slate-100 dark:border-slate-700 mt-4 pt-3 flex items-center justify-between">
                ...
                <span className="text-xs font-medium text-slate-900 dark:text-slate-100">1,240 students</span>
            </div>
        </div>
    );
}
