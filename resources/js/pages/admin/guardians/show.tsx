                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        {guardian.status && (
                                            <Badge className={`rounded-full px-2.5 py-0.5 text-[10px] font-semibold capitalize shadow-sm ${statusColor(guardian.status)}`}>
                                                {guardian.status}
                                            </Badge>
                                        )}
                                        {guardian.has_login && (
                            ...
                            <Card className="overflow-hidden rounded-xl border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                                ...
                                <CardContent className="p-5">
                                    ...
                                    {(guardian.city || guardian.state || guardian.country || guardian.postal_code) && (
                                        <>
                                            <div className="mt-6 mb-3 flex items-center gap-2 text-[10px] font-bold tracking-wide text-slate-400 uppercase">
                                ...
                                <CardContent className="p-4">
                                    {linkedStudents.length === 0 ? (
                                        <div className="flex flex-col items-center justify-center py-8 text-center">
                                            ...
                                            <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-100">No children linked yet</h3>
