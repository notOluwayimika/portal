 ...
 * Verified at this commit: bin/quality:280 (arch) is `pest --group=arch` and the suite step is plain
 * `pest`; `--parallel` appears only on Pint. Every plant and every edit is undone in a `finally`;
